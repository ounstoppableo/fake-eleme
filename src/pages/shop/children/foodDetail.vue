...
export default {
  data() {
    return {
      ...
      month_sales: this.$route.query.month_sales,
      rating_count: this.$route.query.rating_count,
      satisfy_rate: this.$route.query.satisfy_rate,
      foods: this.$route.query.foods,
      shopId: this.$route.query.shopId
    };
  },
  components: { headTop,ratingStar },
};
</script>
